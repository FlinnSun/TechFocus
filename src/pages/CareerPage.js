          ...
          <div className="leadership-content">
            ...
            <div className="leader-info">
              ...
              <p className="leader-description">
                Lijuan Wang is the founder and President of TechFocus LLC, dedicated to delivering high-impact technology solutions and IT hardware to U.S. federal agencies.
              </p>
              <p className="leader-description">
